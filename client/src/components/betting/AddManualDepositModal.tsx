...
interface AddManualDepositModalProps {
  open: boolean;
...
export function AddManualDepositModal({
  open,
  onOpenChange,
  currentBankroll,
  onAddDeposit,
}: AddManualDepositModalProps) {
  ...
  const handleSubmit = () => {
    ...
    toast({
      ...
      description: 'O aporte manual foi registrado com sucesso.',
    });
  };
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Adicione um aporte manual à sua banca
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="title">Título/Nome do Aporte</Label>
            <Input
              id="title"
